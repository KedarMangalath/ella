...
export const commandRegistry: CommandEntry[] = [
  ...
  },
  {
    id: "permissions",
    group: "Workspace",
    description: "List or edit OpenCode-style allow, deny, and ask rules for tools.",
    cli: [
      "ella permissions",
      "ella permissions allow <permission> <pattern>",
      "ella permissions deny <permission> <pattern>",
      "ella permissions ask <permission> <pattern>",
      "ella permissions remove <permission> <pattern>",
    ],
    slash: [
      "/permissions",
    ...
    topLevel: ["permissions", "permission"],
  },
  {
    id: "patch",
    group: "Workspace",
    description: "Apply or preview Ella patch blocks from stdin or arguments.",
    cli: ["ella patch --dry-run", "ella patch"],
    slash: ["/patch <patch-text>"],
    topLevel: ["patch"],
  },
  {
    id: "mcp",
